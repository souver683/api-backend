package com.light.project.controller;
...
import com.light.project.model.dto.interfaceInfo.InterfaceInfoAddRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<String> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson=new Gson();
        com.light.apiclientsdk.model.User user = gson.fromJson(userRequestParams, com.light.apiclientsdk.model.User.class);
        ApiClient useApiClient=new ApiClient(accessKey,secretKey);
        String usernameByPost = useApiClient.getUsernameByPost(user);
...
//        com.light.apiclientsdk.model.User user=new com.light.apiclientsdk.model.User();
